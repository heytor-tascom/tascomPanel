<div class="row fixed-top bg-gray">
        ...
        <div class="col-md-2 border-right">
            <div class="d-flex align-items-center">
                <div class="text-painel w-100 text-center align-middle mx-2 py-2" style="line-height: 1.3em">
                    {{ $title ?? '' }}
                </div>
            </div>
            <div class="ml-3">
                @if(isset($setores))
                @php
                $cdSetor    = (isset($setorId)) ? $setorId : null;
                $cdSetor    = explode(",", $cdSetor);
                @endphp
                <select name="setores" id="" class="selectpicker w-100" onchange="setSetor(this)" data-live-search="true" data-selected-text-format="count" data-actions-box="true">
                    <option value="">&nbsp;</option>
