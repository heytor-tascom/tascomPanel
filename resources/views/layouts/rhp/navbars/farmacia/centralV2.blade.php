            ...
            <div class="col-md-8">
                <div class="d-flex align-items-center flex-wrap mt-3" style="height: 100%;">
                    ...
                    <div class="w-100">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="search" class="form-control srcClass" id="searchInputPatient" onkeyup="searchPatient(4, this)" placeholder="Pesquise pelo nome do paciente...">
                                ...
                                <div class="col-md-6">
                                    <input type="search" class="form-control srcClass" id="searchInputSolic" onkeyup="searchPatient(1, this)" placeholder="Pesquise pela solicitação...">
                                    {{-- <span class="material-icons float-right mt-2 cursor-pointer" onclick="javascript:document.getElementById('searchInput').value=''; searchPatient();">clear</span> --}}
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="search" class="form-control srcClass" id="searchInputTurn" onkeyup="searchPatient(9, this)" placeholder="Pesquise pelo Turno...">
                                    {{-- <span class="material-icons float-right mt-2 cursor-pointer" onclick="javascript:document.getElementById('searchInput').value=''; searchPatient();">clear</span> --}}
                                </div>
                                <div class="col-md-6">
                                    <input type="search" class="form-control srcClass" id="searchInputHourNeces" onkeyup="searchPatient(8, this)" placeholder="Pesquise pela Hora da Necessidade...">
                                    {{-- <span class="material-icons float-right mt-2 cursor-pointer" onclick="javascript:document.getElementById('searchInput').value=''; searchPatient();">clear</span> --}}
                                </div>
                            </div>
        ...
        <div >
            <div class="row">
                <div class="col-md-4">
                      ...
                      <button type="button" id="todas" class="btn btn-secondary " onclick="trocaMetodo('todas')">PRESCRIÇÕES
                      ...
                      <div class="col-md-4">
                      <button type="button" id="transferencias" class="btn btn-secondary button-bar" onclick="trocaMetodo('transferencias')">TRANSF.
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <button type="button" id="legendas" class="btn btn-secondary button-bar" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content='
                        ...
                        <div class="row">
                            <div class="col-md-12" style="font-size:1.4em;"><i class="fas fa-clock text-danger"></i>&nbsp; Atrasadas </div>
                        </div><hr/>
