...
<html lang="pt-BR">
  ...
  <body id="page-index">
    <div class="row">
        <div class="col-md-2">@include('integracao.header.index' ,['altaActive' => 'active'])</div>
        <div class="col-md-10">


    <header class="page-header">
        <div class="container-fluid">
          INTEGRAÇÃO ATENDIMENTOS ALTA DRG<br/><br/>
          <section id="top" class="animate-up">
            ...
            <div class="" style="width: 80em;">
              Pesquisa:<br/>
              <form action="{{ route('searchCadastro') }}" method="get">
                  @csrf
                  <div class="row">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <textarea rows="80" class="form-control" id="return"></textarea>
            </div>
