...
@section('content')
    @include('layouts.rhp.navbars.farmacia.oncologiaSML')
                ...
                <table class="table table-sm" id="tableSolicitacoes">
                    ...
                    <tbody>
                        ...
                        @elseif ($solicitacao->fnc_itpremed == 1)
                            <tr style="color: #a013da; font-weight:600; font-size:0.9em;">
                        @else
                        ...
                        @endif
                                <td class="text-center">
                                    ...
                                    @elseif ($solicitacao->fnc_itpremed == 1)
                                    <i class="material-icons" style="color: #a013da; vertical-align:inherit;">access_time</i>
                                    @else
                                    @endif
                                    ...
                                    @switch($solicitacao->status)
                                        ...
                                        @case('MED_PREP')
                                        <i class="material-icons" style="vertical-align:inherit; color:#53563b;">gradient</i>
                                        @break
...
<script>
    ...
    function viewDetails(a) {
        ...
        let url = '{{ route('painel.farmacia.oncologia.detalhes.sml', ['atendimentoId' => "#atendimento#", 'preMedId' => "#premed#", 'solSaiProId' => "#solsaipro#"]) }}';
