...
class PainelFarmOncoController extends Controller
{
    public function index(Request $request){
       ...
       //dd($solicitacoes);
        ...
        return view("home.produtos.paineis.farmacia.oncologia.index", compact('title', 'solicitacoes', 'setores', 'estoques', 'tempoAtt', 'tipoVisualizacao'));
    }
    ...
    public static function getSolicitacoes($parSetores)
    {
        ...
        return DB::connection('oracle')
                    ...
                    AND   To_Char(SOLSAI_PRO.DT_SOLSAI_PRO,'DD/MM/RRRR') = TO_CHAR(SYSDATE,'DD/MM/RRRR')
                    )
