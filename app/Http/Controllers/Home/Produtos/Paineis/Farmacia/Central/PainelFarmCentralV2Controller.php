...
namespace App\Http\Controllers\Home\Produtos\Paineis\Farmacia\Central;
...
class PainelFarmCentralV2Controller extends Controller
{
    public function index(Request $request)
    {
      $produto  = Produto::find(17);
      ...
      $estoque            = (isset($params['estoque'])) ? $params['estoque'] : 16;
      ...
      $aba = $metodo;
      return view("home.produtos.paineis.farmacia.central.indexV2", compact('todas', 'avulsas', 'transferencias', 'devolucoes', 'controlados', 'atendidas', 'setorSolicitacao', 'lista', 'title', 'tempoAtt', 'setores', 'aba', 'estoque', 'estoques'));
    }
    ...
    public static function todas($parSetores, $parEstoque)
    {
        ...
        return DB::connection('oracle')
                    ->select(
                        ...
                        ),'dd/mm/rrrr hh24:mi:ss') pri_necessidade,
                        TO_CHAR((SELECT Min(h.dh_medicacao) FROM hritsolsai_pro h, itsolsai_pro i
                        WHERE  h.cd_Itsolsai_Pro = i.cd_Itsolsai_Pro
                        AND i.cd_solsai_pro = solsai_pro.cd_solsai_pro
                        ),'dd/mm/rrrr hh24:mi') pri_necessidade_view,
                        to_char(
                                 solsai_pro.dt_solsai_pro, 'dd/mm/rrrr')||' '||to_char(solsai_pro.hr_solsai_pro, 'hh24:mi')
                              DT_HR_SOLSAI_PRO_VIEW,
                        setor.nm_setor,
                        solsai_pro.tp_solsai_pro,
                        to_char(
                                 solsai_pro.dt_solsai_pro, 'dd/mm/rrrr')||' '||to_char(solsai_pro.hr_solsai_pro, 'hh24:mi:ss')
                              DT_HR_SOLSAI_PRO,
                        leito.ds_leito,
                        ...
                        AND SOLSAI_PRO.TP_ORIGEM_SOLICITACAO = 'PRE'
                        AND SOLSAI_PRO.CD_SOLSAI_PRO IN (
                            ...
                            AND solsai_pro.DT_SOLSAI_PRO BETWEEN SYSDATE - 1 AND SYSDATE + 1
                        ORDER BY
                            sn_urgente DESC,
                            pri_necessidade asc ,
                            tp_situacao DESC,
    ...
    public static function avulsas($parSetores, $parEstoque)
    {
        ...
        return DB::connection('oracle')
                    ->select(
                        "SELECT solsai_pro.cd_solsai_pro,
                        TO_CHAR(solsai_pro.hr_solsai_pro,'DD/MM/RRRR HH24:MI:SS') dt_hr_solsai_pro,
                        TO_CHAR(solsai_pro.hr_solsai_pro,'DD/MM/RRRR HH24:MI') dt_hr_solsai_pro_view,
                        null pri_necessidade,
                        setor.nm_setor,
                        solsai_pro.tp_solsai_pro,
                        leito.ds_leito,
                        solsai_pro.tp_situacao,
    ...
    public static function devolucoes($parSetores, $parEstoque)
    {
        ...
        return DB::connection('oracle')
                    ->select(
                        "SELECT solsai_pro.cd_solsai_pro,
                        TO_CHAR(solsai_pro.hr_solsai_pro,'DD/MM/RRRR HH24:MI:SS') pri_necessidade,
                        TO_CHAR(solsai_pro.hr_solsai_pro,'DD/MM/RRRR HH24:MI') pri_necessidade_view,
                        setor.nm_setor,
                        solsai_pro.tp_solsai_pro,
                        leito.ds_leito,
                        solsai_pro.tp_situacao,
    ...
    public static function atendidas($parSetores, $parEstoque)
    {
        ...
        return DB::connection('oracle')
                    ->select(
                        ...
                        ORDER  BY pri_necessidade asc , TP_SITUACAO,NM_PACIENTE ");
                    ...
                    ->select(
                        "SELECT SOLSAI_PRO.CD_SOLSAI_PRO,
                            ...
                            AND SOLSAI_PRO.CD_SOLSAI_PRO IN (
                                ...
                                --AND ( (solsai_pro.ds_obs like '%URGENTE%') or (solsai_pro.ds_obs like '%ENTREGA%IMEDIATA%') )
                                AND DT_SOLSAI_PRO BETWEEN SYSDATE - 1 AND SYSDATE + 1
                                ORDER BY
                                        sn_urgente DESC,
                                        pri_necessidade asc ,
                                        tp_situacao DESC,
